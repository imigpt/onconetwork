    ...
    return (
        <ul className="navigation">
            {menu_data.filter((items) => items.page === "nav_1").map((menu: any) => (
                ...
                >
                    <Link target={menu.target} href={menu.link}
            ...
            <li key={300} className={"menu-item-has-children"} >
                <Link target="_blank" href={'https://oncocure.org/'} className={`section-link onco-button`}>Oncocure</Link> 
            </li> 
