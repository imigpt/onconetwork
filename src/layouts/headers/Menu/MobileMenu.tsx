...
const MobileMenus = ({ setIsActive }: any) => {
    ...
    return (
        <ul className="navigation">
                ...
                <React.Fragment key={i}>
                    {menu.has_dropdown && (
                        <li className="menu-item-has-children">
                            <Link target={menu.target} href={menu.link} onClick={closeSidebar}
                    ...
                    {!menu.has_dropdown && (
                        <li className="menu-item-has-children">
                            <Link target={menu.target} onClick={closeSidebar} href={menu.link} className={`${currentRoute === menu.link ? "active" : ""}`}>
                                {menu.title}
                            </Link>
                        </li>
                    )}
            ...
            <li className="menu-item-has-children">
                <Link  target="_blank"  onClick={closeSidebar} href={'https://oncocure.org/'}>
                Oncocure
                </Link>
            </li>
