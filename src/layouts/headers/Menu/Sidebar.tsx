                ...
                <nav className="menu-box">
                    ...
                    <div className="social-links">
                        <ul className="clearfix list-wrap"> 
                            <li><a href="https://t.me/+Noynjp3cxrY3N2I1" target="_blank"><i className="fab fa-telegram"></i></a></li> 
                            <li><a href="https://x.com/OncoNetworks" target="_blank"><i className="fab fa-twitter"></i></a></li>
                            <li><a href="https://www.instagram.com/onconetwork/" target="_blank"><i className="fab fa-instagram"></i></a></li>                            
                        </ul>
                    </div>
                </nav>
            </div>
